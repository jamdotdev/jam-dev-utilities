...
import { getDetailedMatches, RegexMatch } from "@/components/utils/regex-tester.utils";
          ...
          <div key={matchIndex} className="space-y-2">
            ...
            >
              ...
              <div className="font-mono text-sm bg-background px-2 py-1 rounded border">
                {match.fullMatch || <span className="text-muted-foreground italic">empty</span>}
              </div>

              {match.captureGroups.length > 0 && (
                <div className="mt-3 space-y-2">
                  <div className="text-xs text-muted-foreground">Capture Groups (CSS Box Model)</div>
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-mono text-sm truncate">
                                {group ?? <span className="text-muted-foreground italic">undefined</span>}
                              </span>
                            </div>
                          </div>
                        </TooltipTrigger>
                        <TooltipContent side="right" className="max-w-xs">
                          <p className="font-semibold">Capture Group {groupIndex + 1}</p>
