...
export default function RegexTester() {
  ...
  return (
    <main>
      ...
      {/* Compact SaaS-style toolbar */}
      <section className="container max-w-5xl mb-6">
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm -mx-4 mx-4 px-6 py-5">
          {/* Flags Section - Compact Design */}
          <div className="mb-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              <button
                ...
                className={`group relative flex items-center space-x-2 px-3 py-2.5 rounded-lg border transition-all duration-200 ${
                  flags.global
                    ? "bg-blue-50 border-blue-200 text-blue-900"
                    : "bg-white border-gray-200 text-gray-600 hover:border-gray-300 hover:bg-gray-50"
                }`}
              >
                <div className={`flex items-center justify-center w-6 h-6 rounded font-mono text-sm font-bold ${
                  flags.global ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-500"
                }`}>
                  g
                </div>
                <div className="flex flex-col items-start min-w-0">
                  <span className="text-sm font-medium text-left">Global</span>
                  <span className="text-xs text-gray-500 text-left leading-tight">Find all matches</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start min-w-0">
                  <span className="text-sm font-medium text-left">Ignore Case</span>
                  <span className="text-xs text-gray-500 text-left leading-tight">Case insensitive</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start min-w-0">
                  <span className="text-sm font-medium text-left">Multiline</span>
                  <span className="text-xs text-gray-500 text-left leading-tight">^ $ match breaks</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start min-w-0">
                  <span className="text-sm font-medium text-left">Dot All</span>
                  <span className="text-xs text-gray-500 text-left leading-tight">. matches newlines</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start min-w-0">
                  <span className="text-sm font-medium text-left">Unicode</span>
                  <span className="text-xs text-gray-500 text-left leading-tight">Full Unicode</span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start min-w-0">
                  <span className="text-sm font-medium text-left">Sticky</span>
                  <span className="text-xs text-gray-500 text-left leading-tight">Match at lastIndex</span>
                </div>
              </button>
            </div>
          </div>
          
          {/* Quick Patterns Section - More Compact */}
            ...
            <div className="flex flex-wrap gap-2">
              {Object.entries(commonPatterns).map(([key, patternInfo]) => (
                <button
                  ...
                  className="inline-flex items-center px-2.5 py-1.5 rounded-md text-xs font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 hover:text-gray-900 transition-colors duration-200"
                >
      ...
      <section className="container max-w-5xl mb-6">
        {/* Compact SaaS-style content layout */}
        <div className="space-y-6">
          {/* Pattern Input - Compact Modern Design */}
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div className="p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Regular Expression Pattern</h2>
              </div>
              ...
              {pattern && (
                <div className="mt-4 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                  ...
                  <code className="text-gray-900 font-mono text-sm block">
                    {displayPattern}
                  </code>
                </div>
              )}
          ...
          {/* Test String & Results - Compact Grid */}
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
              <div className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900">Test String</h2>
                </div>
                ...
                <Textarea
                  ...
                  className="font-mono text-sm resize-none border-gray-300 focus:border-purple-500 focus:ring-purple-500 rounded-lg"
                  value={testString}
                />
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
              <div className="p-6">
                ...
                <div className="min-h-[200px] rounded-lg border border-gray-200 bg-gray-50 px-3 py-3 font-mono text-sm overflow-auto">
                  {!pattern.trim() || !testString.trim() ? (
                    ...
                    <div className="text-red-600 flex items-center justify-center h-full">
                      <div className="text-center">
                        <svg className="w-10 h-10 text-red-300 mx-auto mb-3" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                        </svg>
                        <p className="text-sm">Fix the pattern errors above</p>
                      </div>
                    </div>
                  ) : result.totalMatches === 0 ? (
                    <div className="text-orange-600 flex items-center justify-center h-full">
                      <div className="text-center">
                        <svg className="w-10 h-10 text-orange-300 mx-auto mb-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                {result.isValid && result.matches.length > 0 && (
                  <div className="space-y-2.5 mt-4 max-h-32 overflow-y-auto">
                    {result.matches.map((match, index) => (
                      <div key={index} className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <div className="flex items-center space-x-2 mb-1.5">
                          ...
                          <span className="font-mono font-medium text-gray-900 text-sm">"{match.match}"</span>
                        </div>
                          ...
                          {match.groups.length > 0 && (
                            <div className="mt-1">
                              ...
                              {match.groups.map((group, i) => (
                                <span key={i} className="inline-block bg-white border border-gray-200 rounded px-1.5 py-0.5 mr-1 text-xs font-mono">
                                  ${i + 1}: "{group}"
                                </span>
                              ))}
                            </div>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-lg font-semibold text-gray-900">Replace Mode</h2>
                  </div>
                  <TabsList className="grid w-40 grid-cols-2">
                    <TabsTrigger value="test" className="text-xs">Test Only</TabsTrigger>
                    <TabsTrigger value="replace" className="text-xs">Find & Replace</TabsTrigger>
                  </TabsList>
                </div>
                ...
                <TabsContent value="test" className="text-gray-600">
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm">Testing mode is active above. Switch to "Find & Replace" to try replacement functionality.</span>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="replace" className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <Label className="text-sm font-semibold text-gray-900 mb-2 block">Replace With</Label>
                      <Textarea
                        rows={3}
                    ...
                    <div>
                      <Label className="text-sm font-semibold text-gray-900 mb-2 block">Replace Result</Label>
                      <div className="h-20 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-mono overflow-auto">
                        {!pattern.trim() || !testString.trim() ? (
                          <div className="text-gray-500 flex items-center justify-center h-full">
                            <span className="text-xs">Enter pattern and test string</span>
                          </div>
                        ) : (
